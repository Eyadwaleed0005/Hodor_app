...
Hodor is an offline employee attendance and salary management application designed for small businesses, shops, and business owners.

The application provides a simple and organized way to manage employees, record monthly absences, calculate attendance rates, estimate salaries, and review previous performance without requiring an internet connection.

## Features

- Add and manage employee records
- Store employee names, ages, and salaries
- Record employee absences for each month
- View the total absences recorded for each employee
- Calculate employee attendance and commitment rates
- Generate suggested salary amounts based on recorded absences
...
- Access historical employee performance
